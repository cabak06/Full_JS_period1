...
describe("########## Verify the Game Facade ##########", () => {
  ...
  beforeEach(async () => {
    ...
    const positions = [
      positionCreator(12.569260597229004, 55.782522214873225, team1.userName, team1.name, true),
      //TODO --> Change latitude below, to a value INSIDE the radius given by DISTANCE_TO_SEARC, and the position of team1
      positionCreator(12.569797039031982, 55.78234121824336, team2.userName, team2.name, true),
      //TODO --> Change latitude below, to a value OUTSIDE the radius given by DISTANCE_TO_SEARC, and the position of team1
      positionCreator(12.567780017852783, 55.78123108718778, team3.userName, team3.name, true),
    ]
  ...
  describe("Verify nearbyPlayers", () => {
    it("Should not find Team2 (wrong credentials)", async () => {
        try {
            ...
            throw new Error("Should NEVER get here due to wrong credentials")
        } catch (err) {
